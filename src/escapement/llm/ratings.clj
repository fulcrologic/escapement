(ns escapement.llm.ratings
  "Subjective opinion about models — the part that is *ours*, not a fact
   ...
   (coarse 1–10) is the one key the engine reads today, but the value map
   is intentionally open: add `:good-at`, `:tier`, `:avoid?` etc. and any
   chart can filter on it via the declarative model policy — no invocation
   code change needed.
...
(def default-ratings
  ...
  {"claude-opus-4-7"     {:intelligence 10}
   "claude-opus-4-6"     {:intelligence 10}
   "claude-opus-4"       {:intelligence  9}
   "claude-sonnet-4-7"   {:intelligence  8}
   "claude-sonnet-4-6"   {:intelligence  8}
   "claude-sonnet-4-5"   {:intelligence  8}
   "claude-haiku-4-5"    {:intelligence  6}
   "claude-3-5-sonnet"   {:intelligence  7}
   "claude-3-5-haiku"    {:intelligence  5}
   "claude-3-opus"       {:intelligence  8}
   "glm-5.1"             {:intelligence  8}
   "glm-5-turbo"         {:intelligence  7}
   "glm-5"               {:intelligence  8}
   "glm-4.7-flashx"      {:intelligence  6}
   "glm-4.7-flash"       {:intelligence  5}
   "glm-4.7"             {:intelligence  7}
   ...
   "gpt-5-mini"          {:intelligence  7}
   "gpt-5-nano"          {:intelligence  5}
   "gpt-5"               {:intelligence 10}
   "gpt-4.1-mini"        {:intelligence  6}
   "gpt-4.1"             {:intelligence  8}
   "gpt-4o-mini"         {:intelligence  5}
   "gpt-4o"              {:intelligence  7}
